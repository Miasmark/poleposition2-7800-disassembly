...
local lastst=-1
local lastn=-1
emu.register_frame_done(function() local n=mem:read_u8(0x273A)+256*mem:read_u8(0x273B)
  if n~=lastn or f%1200==0 then o:write(string.format("PASS f%d st=%02X p1=%02X%02X p2=%02X%02X rst=%d s2=%02X%02X%02X mask=%02X%02X gap=%d",f,mem:read_u8(0x9D),mem:read_u8(0x9F),mem:read_u8(0x9E),mem:read_u8(0x273B),mem:read_u8(0x273A),mem:read_u8(0x2734),mem:read_u8(0x2770),mem:read_u8(0x2771),mem:read_u8(0x2772),mem:read_u8(0x2739),mem:read_u8(0x2738),s16(0x275C))..string.char(10)); lastn=n end end)

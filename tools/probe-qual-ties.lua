...
emu.register_frame_done(function() local st=mem:read_u8(0x9D)
 if st==0x12 and not qd then qd=true; o:write(string.format("QT f%d A6=%d qst=%d qpos=%d p1lap=%02X.%02X p2lap=%02X.%02X p2qsec=%02X p2lapc=%02X p1out=%d",f,mem:read_u8(0xA6),mem:read_u8(0x2027),mem:read_u8(0x2028),mem:read_u8(0xBD),mem:read_u8(0xBC),mem:read_u8(0x2774),0,mem:read_u8(0x2029),mem:read_u8(0x202A),mem:read_u8(0x2736))..string.char(10)) end end)
local rd=false
emu.register_frame_done(function() if mem:read_u8(0x9D)==0x03 and not rd then rd=true; o:write(string.format("RACE f%d p1out=%d A6=%d qpos=%d park=%d",f,mem:read_u8(0x2736),mem:read_u8(0xA6),mem:read_u8(0x2028),mem:read_u8(0x202B))..string.char(10)) end end)

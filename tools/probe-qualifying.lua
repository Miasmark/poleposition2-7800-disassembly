-- probe-qualifying.lua -- the collide-scenario driver (PHASES etc.) plus "V" lines every
-- 60 frames and at each state change: both scores, both lap times, the clock,
-- the gap, player 1's position ($A6), player 2's qualifying status/position/park
-- flag ($26FC/$26FD/$2700) and both laterals.

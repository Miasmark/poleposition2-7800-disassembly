-- probe-collide-shots.lua -- probe-collide-scenario.lua's driver (no model taps),
-- plus screenshots: at fixed frames (SNAPS) and at fixed delays after every
-- crash either player starts (AUTOSNAP, e.g. "4 20 40 70"). Was coltest.lua:
-- both players scripted: PHASES "len:s1:s2:x1:lat2:hold;..."
